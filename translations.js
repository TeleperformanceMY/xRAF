...
<!-- This placeholder will be replaced by the unified payout table at runtime -->
<div data-tnc-payout></div>
...
<ol>
    <li><strong>支払い</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            ...
            <li><strong>標準ロール：</strong> 候補者が評価に合格した時点でRM50、90日完了後にRM750（<strong>合計RM800</strong>）。</li>
            <li><strong>在宅通訳（Interpreter, Work From Home）：</strong> 初出勤日にRM2,000、90日後にRM3,000（<strong>合計RM5,000</strong>）。</li>
        </ul>
    </li>
    <li><strong>資格条件</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            <li>紹介された候補者は、職位の最低要件を満たす必要があります。</li>
            <li>TPに以前応募したことがある候補者、または元TP従業員は、ボーナス支払いの対象外です。</li>
            <li>紹介対象者は、いかなる国のTPグループの現役従業員（正社員、パートタイム、契約社員、臨時スタッフを含む）ではありません。</li>
    ...
    <li>TPは随時、本プログラムを変更または終了する権利を留保します。</li>
...
<ol>
    ...
    <li><strong>자격 요건</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            <li>추천된 후보자는 해당 직무의 최소 요건을 충족해야 합니다.</li>
            <li>TP에 이전 지원 이력 또는 전직 TP 직원은 보너스 대상이 아닙니다.</li>
...
<ol>
    <li><strong>支付</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            ...
            <li><strong>标准岗位：</strong> 候选人通过评估后 RM50，完成 90 天后 RM750（<strong>合计 RM800</strong>）。</li>
            <li><strong>在家办公口译（Interpreter, Work From Home）：</strong> 入职第一天 RM2,000，90 天后 RM3,000（<strong>合计 RM5,000</strong>）。</li>
        </ul>
    </li>
...
<ol>
    <li><strong>支付方式</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            ...
            <li><strong>標準職位：</strong> 通過評估後 RM50，完成 90 日後 RM750（<strong>合計 RM800</strong>）。</li>
            <li><strong>在家工作口譯（Interpreter, Work From Home）：</strong> 首個上班日 RM2,000，90 日後 RM3,000（<strong>合計 RM5,000</strong>）。</li>
        </ul>
    </li>
    <li><strong>資格要求</strong>:
        <ul style="list-style-type: disc; margin-left: 20px;">
            <li>被推薦人必須符合該職位嘅最低要求。</li>
            <li>曾經申請過TP或者前TP員工將不獲任何獎金。</li>
            <li>被推薦人唔可以係任何國家TP集團嘅現職員工（包括全職、兼職、合約或臨時）。</li>
            <li>實習／兼職推薦唔會有獎金。</li>
        </ul>
    </li>
    <li>你確認被推薦朋友同意TP為招聘用途使用其個人資料。</li>
    <li>你同意TP收集及使用你嘅個人資料作計劃管理。</li>
    <li>TP保留隨時修改或終止本計劃嘅權利。</li>
    <li>所有聘用決定由TP全權決定。</li>
</ol>
